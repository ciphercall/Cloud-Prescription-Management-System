...
namespace AslPrescriptionApi.Controllers.ASL
{
    ...
    {
        private AslPrescriptionApiDbContext db = new AslPrescriptionApiDbContext();
                ...
                else
                {
                    ...
                    if (maxData == 0)
                    {
                        ...
                        if (asluserco.EMAILID != null)
                        {
                            ...
                            try
                            {
                                ...
                                mailCompany.From = new MailAddress("admin@rx.cloudlabbd.com");
                                ...
                                clientComapny.Host = "mail.cloudlabbd.com";
                                clientComapny.Credentials = new NetworkCredential("admin@rx.cloudlabbd.com", "123@prescribe#%asl");
                                clientComapny.EnableSsl = false;
                                clientComapny.Send(mailCompany);
                            }
                            catch (Exception e)
                            {
                                TempData["UserCreationMessage"] = e;
                            }
                    ...
                    if (asluserco.EMAILID != null)
                    {
                        ...
                        try
                        {
                            ...
                            mail.From = new MailAddress("admin@rx.cloudlabbd.com");
                            ...
                            client.Host = "mail.cloudlabbd.com";
                            client.Credentials = new NetworkCredential("admin@rx.cloudlabbd.com", "123@prescribe#%asl");
